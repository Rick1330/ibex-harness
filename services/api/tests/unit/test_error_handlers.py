...
def test_api_and_validation_handlers() -> None:
    set_current("22222222-2222-4222-8222-222222222222")
    request = _request(Settings(database_url=None))

    resp = api_error_handler(request, ApiError(code="NOT_FOUND", message="missing"))
    assert resp.status_code == 404

    resp = request_validation_error_handler(
        request,
...
def test_http_exception_dict_and_status_mapping() -> None:
    set_current("22222222-2222-4222-8222-222222222222")
    request = _request(Settings(database_url=None))
...
def test_http_exception_incomplete_detail_dict() -> None:
    set_current("22222222-2222-4222-8222-222222222222")
    request = _request(Settings(database_url=None))
...
def test_unhandled_and_auth_helpers() -> None:
    set_current("22222222-2222-4222-8222-222222222222")
    settings = Settings(database_url=None)
    request = _request(settings)

    resp = unhandled_error_handler(request, RuntimeError("x"))
