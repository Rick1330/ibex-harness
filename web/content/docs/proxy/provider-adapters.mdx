...
<Callout type="info" title="Phase 2 progress">
  ...
  [2.1.4](/roadmap/phase-2-single-provider/milestones/2.1.4-provider-routing-middleware) ship `packages/provider`,
  the OpenAI adapter, SSE dual-write forwarding, and provider routing middleware per
