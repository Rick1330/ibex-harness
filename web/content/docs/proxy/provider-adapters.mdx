...
<Callout type="info" title="Phase 2 progress">
  Milestones [2.1.1](/roadmap/phase-2-single-provider/milestones/2.1.1-provider-interface-and-registry),
  [2.1.2](/roadmap/phase-2-single-provider/milestones/2.1.2-openai-non-streaming-client), and
  [2.1.3](/roadmap/phase-2-single-provider/milestones/2.1.3-openai-streaming-forwarder) ship `packages/provider`,
  the OpenAI adapter, and SSE dual-write forwarding per [ADR-0025](/docs/adr/0025-llm-provider-abstraction),
