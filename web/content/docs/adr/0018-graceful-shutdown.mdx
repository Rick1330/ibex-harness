...
Ad-hoc signal handling in `main.go` is forbidden (`AGENTS.md`).
...
Canonical name per `AGENTS.md`. Documented in service `.env.example` files and [ENVIRONMENT_VARIABLES.md](/docs/environment_variables).
