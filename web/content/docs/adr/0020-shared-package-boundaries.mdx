...
- Phase 2 Python services document pydantic-settings pattern separately ([07-python-code-quality.mdc](/AGENTS.md))
...
- [ARCHITECTURE_LAYERING.md](/engineering/ARCHITECTURE_LAYERING) — consumer-owned ports vs intentional shared package interfaces (`session` / `idempotency` / `directive`)