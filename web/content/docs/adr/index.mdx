...
Browse the sidebar for individual records (ADR-0002 through ADR-0038, including ADR-0034 performance methodology, ADR-0035 chat Idempotency-Key, and planning ADRs such as 0029 and 0038).
