...
Browse the sidebar for available records through ADR-0039 (including ADR-0034 performance methodology, ADR-0035 chat Idempotency-Key, ADR-0038 context assembly, and ADR-0039 proxy Postgres session/directive ownership). Numbers are not contiguous — ADR-0036 and ADR-0037 are not published.
