---
title: "ADR-0016: Proxy agent identity verification (Phase 1)"
description: "Architecture decision record 0016."
adrId: "0016"
status: "Accepted"
date: "2026-06-06"
...
| Rate limit (M1.2.4) | Fail closed in the current Proxy runtime (historical Phase 1 behavior superseded by [ADR-0081](/docs/adr/0081-fail-closed-proxy-runtime-controls)) | 503 | `SERVICE_DEGRADED` |
...
Amends [ADR-0013](/docs/adr/0013-proxy-input-validation-and-error-envelope) §8 and [ADR-0015](/docs/adr/0015-proxy-rate-limit-skeleton) §6:
...
- [Milestone 1.2.5](/roadmap/phase-1-core-platform/milestones/1.2.5-proxy-agent-identity-verification)
