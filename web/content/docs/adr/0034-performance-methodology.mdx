...
**Numbering note:** Phase 3 milestone pages previously reserved “ADR-0034” for memory write + PII. **This ADR owns 0034** (Phase 2 performance). Phase 3 memory write decisions are **ADR-0054** (PII), **ADR-0055** (dedup), **ADR-0056** (conflict), and **ADR-0057** (write orchestration) — not ADR-0042 (self-hosted adapter).
