...
**Numbering note:** Phase 3 milestone pages previously reserved “ADR-0034” for memory write + PII. **This ADR owns 0034** (Phase 2 performance). Phase 3 must use the next free ID (**ADR-0039**) when that decision is written.
