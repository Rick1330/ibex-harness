---
title: "ADR-0019: OpenTelemetry provider configuration (Phase 1)"
description: "Architecture decision record 0019."
adrId: "0019"
status: "Accepted"
date: "2026-06-07"
...
- Tracers obtained via `providers.TracerProvider.Tracer("ibex-<service>")` — no `otel.Tracer()` in service code ([29-ibex-packages.mdc](/AGENTS.md))
...
- [ADR-0017](/docs/adr/0017-request-id-strategy)
- [ADR-0018](/docs/adr/0018-graceful-shutdown)
- [18-observability.mdc](/AGENTS.md)