...
- [x] `StreamAccumulator` collects full content without blocking the forward path
- [x] Provider error mid-stream results in partial stream + trace with `is_complete=false` (not a server crash)
