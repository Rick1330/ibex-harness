...
fullTitle: "Milestone 2.3.1 — Directive Schema Migrations (`directives` + `directive_versions`)"
---
...
**ADR:** [ADR-0030](/docs/adr/0030-directive-versioning)
...
- [x] Migrations 000009 apply cleanly in sequence
- [x] RLS enforced on both tables
- [x] `directive_versions.content` has ≤ 32KB constraint
- [x] `active_version_id` FK validated successfully
- [x] ADR-0030 written documenting immutable versioning strategy
