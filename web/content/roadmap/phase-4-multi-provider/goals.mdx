---
title: "Phase 4 — Goals"
description: "Description: Pluggable adapters behind a stable internal interface in `services/proxy`."
summary: "Description: Pluggable adapters behind a stable internal interface in `services/proxy`."
...
- **Behavioural fingerprints, drift alerts, and billing** — deferred to [Phase 6 — Intelligence & Monetization](/roadmap/phase-6-intelligence-monetization) (not Phase 4 scope)