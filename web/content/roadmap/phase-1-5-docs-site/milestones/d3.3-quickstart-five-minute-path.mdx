...
description: "Historical Phase 1.5 milestone: quickstart honesty when chat was still a 501 stub. Superseded by late Phase 2 mock/live docs."
summary: "Historical Phase 1.5 milestone: quickstart honesty when chat was still a 501 stub. Superseded by late Phase 2 mock/live docs."
status: "completed"
milestoneId: "d3.3"
...
<Callout type="info" title="Historical milestone">
  Spec written for Phase 1.5 when chat could still return a `501` stub. The live quickstart now documents mock-mode HTTP 200 — see [Quickstart](/docs/getting-started/quickstart).
</Callout>
...
Must reflect Phase 1 reality **at the time**: auth probe works, chat may return 501 stub — document honestly.
