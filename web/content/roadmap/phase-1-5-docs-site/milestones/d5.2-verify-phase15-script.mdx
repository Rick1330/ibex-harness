...
description: "Launch gate (D.6) needs a single script operators run against preview or production to confirm redirects, key pages, 404, OG, and search API — not ad-hoc curl commands. Encodes acceptance criteria from D.2.8, D.2.4, D.2.5 into repeatable smoke."
summary: "Launch gate (D.6) needs a single script operators run against preview or production to confirm redirects, key pages, 404, OG, and search API — not ad-hoc curl commands. Encodes acceptance criteria from D.2.8, D.2.4, D.2.5 into repeatable smoke."
status: "completed"
milestoneId: "d5.2"
