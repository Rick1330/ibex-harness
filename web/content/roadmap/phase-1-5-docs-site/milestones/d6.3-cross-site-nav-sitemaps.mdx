...
- [x] `https://ibexharness.com/` serves landing page
- [x] `https://ibexharness.com/docs/...` serves docs (unchanged)
- [x] Nav Home/logo links to `/` (internal)
- [x] `docs.ibexharness.com/*` 301s to apex (post-cutover)
