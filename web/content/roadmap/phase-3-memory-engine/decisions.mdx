...
| ADR-0045 | Token budget calculator | 3.5.2 | Pending |
| ADR-0040 | Management API auth middleware | 3.6.1 | Pending |
| ADR-0041 | MinIO session archive format | 3.7.1 | Pending |
| ADR-0042 | Memory write pipeline + PII | 3.3.2 | Pending |

Pending rows are **reserved IDs only**. They do not appear in the ADR sidebar / `meta.json` until the milestone writes and indexes the ADR (same pattern as ADR-0036 / ADR-0037).
