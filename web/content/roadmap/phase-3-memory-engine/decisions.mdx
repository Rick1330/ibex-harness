...
| ADR-0042 | Memory write pipeline + PII (planning alias) | 3.C.* | **Not used** — ADR-0042 is the self-hosted OpenAI-compatible adapter. Write pipeline shipped as ADR-0054 (PII), ADR-0055 (dedup), ADR-0056 (conflict), ADR-0057 (write orchestration / 3.C.5) |
