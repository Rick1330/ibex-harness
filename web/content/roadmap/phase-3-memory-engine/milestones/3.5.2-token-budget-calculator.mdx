...
**ADR required (pending — not yet written):** ADR-0045 — Token budget allocation strategy
...
## ADR-0045 — Token budget allocation strategy (to be written)
...
- [ ] ADR-0045 written with token reserve rationale and model table
