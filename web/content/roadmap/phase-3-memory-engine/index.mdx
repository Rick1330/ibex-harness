...
<Callout type="info" title="Entry condition">
  **Phase 2 is complete on `main`.** Start here for memory, context assembly, workers, the management API, and the operator dashboard. Do not treat Python paths under `services/` as implemented until these milestones land.
</Callout>
