...
Phase 3 ADRs below are **planned titles** — assign the next free numbers at write time
(do **not** reuse 0040–0046).

| Planned topic | Notes |
|---|---|
| Memory schema v2 expand (HNSW, multi-label) | Expands G5.M1 / ADR-0047; not a greenfield CREATE |
| Vector store + composite scoring v2 | |
| Temporal-interval-aware conflict detection | Builds on ADR-0047 columns |
| Memory service tenant isolation (RLS + app-layer) | |
