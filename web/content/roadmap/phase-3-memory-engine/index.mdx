...
| ADR-0041 | Vector store abstraction and composite scoring formula v2 |
| ADR-0042 | Temporal-interval-aware conflict detection |
| ADR-0043 | Memory service tenant isolation model (RLS + app-layer double enforcement) |
| ADR-0044 | Retrieval-quality benchmark methodology |
...
9. ADR-0040 through ADR-0044 published and cross-linked from the phase decision log
