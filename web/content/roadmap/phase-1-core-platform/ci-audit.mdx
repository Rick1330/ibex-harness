...
| `coverage` | `coverage` | Merged unit+integration Go coverage ≥94% on hand-written scope | Medium: Postgres service required | `infra/scripts/coverage-gate.sh` filters `packages/proto/gen/go` |
