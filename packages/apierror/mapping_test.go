...
func TestHTTPStatus_allRegisteredCodes(t *testing.T) {
	...
	cases := []struct {
		...
		{apierror.CodeModelNotAllowed, http.StatusForbidden},
		{apierror.CodePermissionElevationDenied, http.StatusForbidden},
		...
		{apierror.CodeInvalidCredential, http.StatusUnprocessableEntity},
		...
		{apierror.CodeOrgSuspended, http.StatusForbidden},
		{apierror.CodeLastOwnerProtected, http.StatusConflict},
		{apierror.CodeAgentSlugConflict, http.StatusConflict},
		{apierror.CodeAgentHasSessions, http.StatusConflict},
		{apierror.CodeAgentStatusConflict, http.StatusConflict},
		{apierror.CodeModelPolicyPatternConflict, http.StatusConflict},
		{apierror.CodeRateLimited, http.StatusTooManyRequests},
		{apierror.CodeBudgetExceeded, http.StatusPaymentRequired},
		...
		{apierror.CodeLegalHoldActive, http.StatusConflict},
...
func TestGRPCCode_allRegisteredCodes(t *testing.T) {
	...
	cases := []struct {
		...
		{apierror.CodeModelNotAllowed, codes.PermissionDenied},
		{apierror.CodePermissionElevationDenied, codes.PermissionDenied},
		...
		{apierror.CodeInvalidCredential, codes.InvalidArgument},
		...
		{apierror.CodeOrgSuspended, codes.PermissionDenied},
		{apierror.CodeLastOwnerProtected, codes.FailedPrecondition},
		{apierror.CodeAgentSlugConflict, codes.AlreadyExists},
		{apierror.CodeAgentHasSessions, codes.FailedPrecondition},
		{apierror.CodeAgentStatusConflict, codes.Aborted},
		{apierror.CodeModelPolicyPatternConflict, codes.AlreadyExists},
		{apierror.CodeRateLimited, codes.ResourceExhausted},
		{apierror.CodeBudgetExceeded, codes.ResourceExhausted},
		{apierror.CodeIdempotencyKeyReuse, codes.AlreadyExists},
		{apierror.CodeIdempotencyInProgress, codes.Aborted},
