...
We need a tool choice, directory layout, DSN conventions (Python services use `postgresql+asyncpg://`; Go uses `lib/pq`), CI policy, and rollback rules consistent with [DATABASE_SCHEMA.md](../DATABASE_SCHEMA.md) and [SECURITY.md](../SECURITY.md).
...
- **Schema evolution:** Follow expand-contract in [DATABASE_SCHEMA.md](../DATABASE_SCHEMA.md); production does not automate `down`.
...
- Tenant tables enable RLS with policies from [DATABASE_SCHEMA.md](../DATABASE_SCHEMA.md).
...
- **Not** added to branch protection required checks ([ADR-0003](ADR-0003-branch-protection-and-merge-policy.md)).
...
- [Milestone 1.1.1](../roadmap/phase-1-core-platform/milestones/1.1.1-postgres-migrations.md)
