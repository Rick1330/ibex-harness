...
description: "Maps public Fumadocs pages (`docs/app/content/docs/`) to engineering sources in repo-root `docs/`. Do not wholesale-port future Phase 2+ API spec."
summary: "Maps public Fumadocs pages (`docs/app/content/docs/`) to engineering sources in repo-root `docs/`. Do not wholesale-port future Phase 2+ API spec."
...
Draft extraction helper: `docs/app/scripts/port-engineering-content.mjs` (`--list`, `--map <slug>`).
