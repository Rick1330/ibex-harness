...
- Long-term publishing to `main` moves to a **separate repository** running a dedicated GitHub App (see `docs/BENCHMARK_BOT.md`).
...
| Keep publishing with `github.actor` skip only | Still mutates PR branch; external app is the long-term home for writes |

## References

- PR #177 benchmark pre-PR pipeline work
- [`docs/BENCHMARK_BOT.md`](../../../../BENCHMARK_BOT.md) — external app specification (follow-up)
