...
- `.nvmrc` — `20.18.0`
- `apps/docs/CONTRIBUTING.md` — branch naming, anti-patterns, `pnpm docs:dev`
...
| `apps/docs/CONTRIBUTING.md` | Add | Contributor guide for docs app |

---

## Testing Requirements

- **`verifyCursorRules_ActiveForAppsDocs`**: Editing `apps/docs/**` shows docs-site rule active
...
- [ ] Cursor status shows project rules active under `apps/docs/`
- [ ] `.editorconfig` present at repo root
- [ ] `apps/docs/CONTRIBUTING.md` documents no-gradient / no-blur rules
...
| --- | --- | --- | --- |
| Rules ignored on non-`apps/docs` paths | Medium | Low | Scope globs to `apps/docs/**` only |
