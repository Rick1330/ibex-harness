...
| --- | --- | --- |
| `apps/docs/src/lib/search.ts` | Add/Modify | Orama advanced search API |
| `apps/docs/src/components/search-dialog.tsx` | Modify | Matte Graphite dialog skin |
| `apps/docs/src/components/layout/nav-search.tsx` | Modify | Kbd hint in nav |
