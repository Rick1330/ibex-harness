...
Spec detail: [MASTER_BRIEF.md](../MASTER_BRIEF.md) Part D (D.3.2).
...
- [D.3.1](d3.1-information-architecture-meta-json.md) merged
...
| --- | --- | --- |
| `apps/docs/content/docs/**/*.mdx` | Modify | Section content per wave |
| `docs/roadmap/phase-1-5-docs-site/CONTENT_SOURCES.md` | Reference | Source mapping |
