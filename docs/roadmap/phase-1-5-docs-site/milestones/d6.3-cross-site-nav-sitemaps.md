...
- `apps/docs/app/robots.ts` and `apps/docs/app/sitemap.ts`
...
| --- | --- | --- |
| `apps/docs/app/robots.ts` | Add | Docs robots |
| `apps/docs/app/sitemap.ts` | Add | Docs sitemap |
| `apps/docs/src/lib/layout.config.tsx` | Modify | External landing link |
