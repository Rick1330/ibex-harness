...
Spec detail: [MASTER_BRIEF.md](../MASTER_BRIEF.md) Part D (D.2.2).
...
| --- | --- | --- |
| `apps/docs/src/app/globals.css` | Add/Modify | Matte Graphite tokens |
| `apps/docs/tailwind.config.ts` | Modify | Tailwind color bridge |
| `apps/docs/src/app/layout.tsx` | Modify | Fonts and metadata |
