...
Spec detail: [MASTER_BRIEF.md](../MASTER_BRIEF.md) Part D (D.2.7).
...
| --- | --- | --- |
| `apps/docs/src/components/layout/docs-sidebar.tsx` | Modify | Sidebar chrome |
| `apps/docs/src/components/layout/breadcrumb.tsx` | Add/Modify | Breadcrumb trail |
| `apps/docs/src/components/layout/toc.tsx` | Modify | On-this-page rail |
| `apps/docs/src/lib/layout.config.tsx` | Modify | Wordmark nav config |
