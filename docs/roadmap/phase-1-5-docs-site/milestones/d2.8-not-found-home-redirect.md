...
- `apps/docs/src/app/not-found.tsx` — 72px mono `404`, outline buttons
...
| --- | --- | --- |
| `apps/docs/src/app/not-found.tsx` | Add | Styled 404 page |
| `apps/docs/next.config.mjs` | Verify | Root redirect intact |
